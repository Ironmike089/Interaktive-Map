  ...
  function buildSteps() {
    ...
    return [
      ...
      },
      {
        ...
        text: "Dafür verbindest du dich in Claude Code mit dem Repository und lässt dir dort über den „medipulse-infosheet“-Skill ein Infosheet zu dieser Praxis erstellen. Du bekommst daraufhin ein fertiges PDF sowie eine passende .txt-Datei zurück. Die .txt-Datei lädst du hier über „📎 Stattdessen .txt-Datei hochladen“ hoch — die Felder Trigger, Firmografie, Struktur, Produkt und Painpoints werden automatisch anhand der Überschriften befüllt. Alternativ fügst du den kompletten Text oben ein und klickst „Auf die Felder unten verteilen“. Ganz ohne Recherche lassen sich die Felder darunter auch von Hand ausfüllen.",
      },
      {
